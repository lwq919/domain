        ...
        <table style={{ width: '100%' }}>
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={showRegistrar && showProgress ? 11 : 9} className="loading" style={{ textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%' }}>暂无域名数据</td></tr>
